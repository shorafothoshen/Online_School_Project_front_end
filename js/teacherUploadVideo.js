document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const response = await fetch(`https://online-school-989z.onrender.com/api/teachers/${userId}/courses/${courseId}/weeks/`);
...
const uploadVideo = async (event) => {
    ...
    if (videoFile && userId && courseId) {
        ...
        try {
            const response = await fetch(`https://online-school-989z.onrender.com/api/teachers/${userId}/videos/`, {
                method: 'POST',
                body: formData,
            });
...
async function fetchVideos() {
    ...
    try {
        const response = await fetch(`https://online-school-989z.onrender.com/api/teachers/${userId}/courses/${courseId}/videos/`);
